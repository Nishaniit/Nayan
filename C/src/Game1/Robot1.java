...
public class Robot1 extends HP_Render
{
    ...
    {
        super(new HP(20,20));
        this.image=new ImageIcon(getClass().getResource("/Game1/100-02.png")).getImage();
        Path2D p=new Path2D.Double();
        p.moveTo(Robot_size * .1, Robot_size * 0.5);      // left middle
        p.lineTo(Robot_size * 0.25, Robot_size * 0.01);     // upper left
        p.lineTo(Robot_size * 0.75, Robot_size * 0.02);     // upper right
        p.lineTo(Robot_size * .9, Robot_size * 0.5);
        p.lineTo(Robot_size * 0.75, Robot_size * 1);
        p.lineTo(Robot_size * 0.25, Robot_size * 1);
        p.closePath();
    ...
    public void draw(Graphics2D g2)
    {
        ...
        at2.rotate(Math.toRadians(angle+180),Robot_size/2,Robot_size/2);
